...
import { Eye, EyeOff, User, Lock, ArrowLeft, Loader2, Building2, AlertCircle } from "lucide-react"
...
export default function AcessoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await loginCliente(formDataObj)
    } catch (err) {
      console.error("Login error:", err)
      // Definir uma mensagem de erro a partir do backend ou genérica
      // Por enquanto, usaremos a mensagem do searchParams
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="glass-effect rounded-2xl p-6 sm:p-8 shadow-2xl sm:px-8 sm:py-8">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-white mt-4">Área do Cliente</h1>
